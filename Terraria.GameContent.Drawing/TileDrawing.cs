...
public class TileDrawing
{
	...
	public TileDrawing(TilePaintSystemV2 paintSystem)
	{
		...
		for (int num = 0; num < _specialPositions.Length; num++)
		{
			_specialPositions[num] = new Point[9000];
		}
	}
			...
			try
			{
				...
				if (flag2 && frameY >= 198 && frameX >= 22)
				{
					...
					case 22:
					{
						...
						Main.spriteBatch.Draw(treeTopTexture, position3, new Rectangle(treeFrame * (topTextureFrameWidth3 + 2), 0, topTextureFrameWidth3, topTextureFrameHeight3), color6, num15 * num3, new Vector2(topTextureFrameWidth3 / 2, topTextureFrameHeight3), 1f, SpriteEffects.None, 0f);
						if (type == 634)
						{
							Texture2D value3 = TextureAssets.GlowMask[316].Value;
							Color white3 = Color.White;
							Main.spriteBatch.Draw(value3, position3, new Rectangle(treeFrame * (topTextureFrameWidth3 + 2), 0, topTextureFrameWidth3, topTextureFrameHeight3), white3, num15 * num3, new Vector2(topTextureFrameWidth3 / 2, topTextureFrameHeight3), 1f, SpriteEffects.None, 0f);
						}
						break;
					}
					case 44:
				...
				if (type == 323 && frameX >= 88 && frameX <= 132)
				{
					...
					Main.spriteBatch.Draw(treeTopTexture2, position4, new Rectangle(num16 * (num17 + 2), y2, num17, num18), color7, num21 * num3, new Vector2(num17 / 2, num18), 1f, SpriteEffects.None, 0f);
				}
			}
			catch
			{
