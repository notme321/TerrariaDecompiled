...
public static class TextureAssets
{
	...
	public static Asset<Texture2D>[] AccFace = new Asset<Texture2D>[ArmorIDs.Face.Count];

	public static Asset<Texture2D>[] AccBalloon = new Asset<Texture2D>[ArmorIDs.Balloon.Count];

	public static Asset<Texture2D>[] AccBeard = new Asset<Texture2D>[ArmorIDs.Beard.Count];
	...
	public static Asset<Texture2D>[] Chains = new Asset<Texture2D>[ChainID.Count];
	...
	public static Asset<Texture2D>[] Item = new Asset<Texture2D>[ItemID.Count];

	public static Asset<Texture2D>[] ItemFlame = new Asset<Texture2D>[ItemID.Count];

	public static Asset<Texture2D>[] Npc = new Asset<Texture2D>[NPCID.Count];

	public static Asset<Texture2D>[] Projectile = new Asset<Texture2D>[ProjectileID.Count];
	...
	public static Asset<Texture2D>[] GlowMask = new Asset<Texture2D>[GlowMaskID.Count];

	public static Asset<Texture2D>[] Extra = new Asset<Texture2D>[ExtrasID.Count];

	public static Asset<Texture2D>[] HighlightMask = new Asset<Texture2D>[TileID.Count];
	...
	public static Asset<Texture2D>[] Tile = new Asset<Texture2D>[TileID.Count];

	public static Asset<Texture2D> BlackTile;

	public static Asset<Texture2D>[] Wall = new Asset<Texture2D>[WallID.Count];
