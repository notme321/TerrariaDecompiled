...
public struct MapTile
{
	...
	public byte Color
	{
		get
		{
			return (byte)(_extraData & 0x7F);
		}
		set
		{
			_extraData = (byte)((_extraData & 0x80) | (value & 0x7F));
		}
	}
	...
	{
		return new MapTile(Type, light, (byte)(_extraData | 0x80));
	}

	public static MapTile Create(ushort type, byte light, byte color)
	{
		return new MapTile(type, light, (byte)(color | 0x80));
	}
}
