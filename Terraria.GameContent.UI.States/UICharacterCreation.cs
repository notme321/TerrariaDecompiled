...
public class UICharacterCreation : UIState
{
	...
	private void SetupGamepadPoints(SpriteBatch spriteBatch)
	{
		...
		case CategoryId.CharInfo:
		{
			...
			{
				UILinkPoint andSet3 = GetAndSet(num3, list2[num7]);
		...
		case CategoryId.HairStyle:
		{
			...
			{
				SnapPoint snapPoint4 = list2[num8];
		...
		default:
		{
			...
			{
				UILinkPoint andSet5 = GetAndSet(num3, list4[num9]);
				andSet5.Up = num2 + 2;
			...
			{
				UILinkPoint andSet6 = GetAndSet(num3, list2[num10]);
		...
		case CategoryId.Clothing:
		{
			...
			{
				UILinkPoint andSet = GetAndSet(num3, list3[num5]);
				andSet.Up = num2 + num5 + 2;
			...
			{
				UILinkPoint andSet2 = GetAndSet(num3, list2[num6]);
				andSet2.Up = num + 2 + num6;
